...
// Logger is an implementation of service logx.
type Logger struct {
...
// SetLogConfig set the config of logx module, called in initialization of config module
...
// After one module get the logx, the module can use it forever until the program terminate.
...
// One module can get a logx for each chain, then logx can be use forever until the program terminate.
